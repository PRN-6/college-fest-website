...
const Model = () => {
    ...
    useEffect(() => {
        ...
        // Section 3 (Timeline Persistence): 30% - 50%
        triggers.push(
            ScrollTrigger.create({
                trigger: document.body,
                start: "30% center",
        ...
        // Section 4 (Events Persistence / Model Fade Out): 50% - 85%
        triggers.push(
            ScrollTrigger.create({
                trigger: document.body,
                start: "50% center",
                ...
                onUpdate: (self) => {
                    ...
                    const baseScale = isMobile ? 0.3 : 0.5;

                    if (group.current) {
                        group.current.scale.setScalar(baseScale * (1 - progress));
        ...
        // Section 5 (Footer Persistence): 85% - 100%
        triggers.push(
            ScrollTrigger.create({
                trigger: document.body,
                start: "85% center",
